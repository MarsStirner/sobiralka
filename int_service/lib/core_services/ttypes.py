...
class AddPatientParameters(object):
  ...
  thrift_spec = (
    ...
    (4, TType.I64, 'birthDate', None, None, ), # 4
    (5, TType.I32, 'sex', None, None, ), # 5
    (6, TType.STRING, 'docSerial', None, None, ), # 6
    (7, TType.STRING, 'docNumber', None, None, ), # 7
    (8, TType.STRING, 'docTypeCode', None, None, ), # 8
  ...
  def __init__(self, lastName=None, firstName=None, patrName=None, birthDate=None, sex=None, docSerial=None, docNumber=None, docTypeCode=None, policySerial=None, policyNumber=None, policyTypeCode=None, policyInsurerInfisCode=None,):
    self.lastName = lastName
    self.firstName = firstName
    self.patrName = patrName
    self.birthDate = birthDate
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.docSerial = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.STRING:
          self.docNumber = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.STRING:
          self.docTypeCode = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.sex is not None:
      ...
      oprot.writeI32(self.sex)
      oprot.writeFieldEnd()
    if self.docSerial is not None:
      oprot.writeFieldBegin('docSerial', TType.STRING, 6)
      oprot.writeString(self.docSerial.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.docNumber is not None:
      oprot.writeFieldBegin('docNumber', TType.STRING, 7)
      oprot.writeString(self.docNumber.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.docTypeCode is not None:
      oprot.writeFieldBegin('docTypeCode', TType.STRING, 8)
      oprot.writeString(self.docTypeCode.encode('utf-8'))
      oprot.writeFieldEnd()
...
class FindPatientByPolicyAndDocumentParameters(object):
  ...
  def validate(self):
    ...
    if self.policySerial is None:
      raise TProtocol.TProtocolException(message='Required field policySerial is unset!')
